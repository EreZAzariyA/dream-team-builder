...
class S3Service {
  ...
  generateKey(userId, context, agentId, filename, team = null, workflowId = null) {
    if (context === 'agents-chat') {
      ...
      if (!team || !workflowId) {
        console.error(`❌ [S3Service] Missing required parameters for agent-teams context:`, {
          team: team || 'MISSING',
        ...
        throw new Error(`Team and workflowId are required for agent-teams context. Got team: ${team}, workflowId: ${workflowId}`);
      }
