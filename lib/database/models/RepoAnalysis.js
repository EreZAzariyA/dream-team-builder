...
const RepoAnalysisSchema = new mongoose.Schema({
  ...
  insights: {
    ...
    categories: {
      codeQuality: { type: Array, default: [] },
      security: { type: Array, default: [] },
      performance: { type: Array, default: [] },
      maintainability: { type: Array, default: [] },
      documentation: { type: Array, default: [] },
      testing: { type: Array, default: [] }
    },
    generatedAt: Date, // When insights were last generated
    generatedBy: String, // Agent that generated insights (e.g., 'qa')
    version: { type: String, default: '1.0' } // Insights schema version
  },
  gitHistory: {
    commits: { type: Array, default: [] }, // Last 30-50 commits
    branches: { type: Array, default: [] }, // Available branches
    defaultBranch: String, // Default branch name
    fetchedAt: Date, // When git history was last fetched
    totalCommits: Number, // Total number of commits in history
    contributors: { type: Array, default: [] }, // Top contributors
    version: { type: String, default: '1.0' } // Git history schema version
  },
