...
const WorkflowSchema = new mongoose.Schema({
  ...
  // Workflow Status - Updated to support BMAD statuses
  status: {
    type: String,
    enum: [
            'draft', 'initializing', 'running', 'completed', 'paused', 'error', 'cancelled', // Original statuses
      'RUNNING', 'COMPLETED', 'PAUSED', 'ERROR', 'CANCELLED', 'PAUSED_FOR_ELICITATION' // BMAD statuses
    ],
    default: 'draft',
  },
