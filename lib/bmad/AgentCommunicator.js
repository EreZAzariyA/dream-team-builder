...
class AgentCommunicator extends EventEmitter {
  ...
  async handleActivationMessage(message) {
    console.log(`Activating agent ${message.to} for workflow ${message.workflowId}`);
  ...
  async handleCompletionMessage(message) {
    console.log(`Agent ${message.from} completed in workflow ${message.workflowId}`);
  ...
  async handleInterAgentMessage(message) {
    console.log(`Inter-agent message from ${message.from} to ${message.to}`);
